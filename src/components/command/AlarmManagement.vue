    ...
    <el-card class="box-card">
      ...
      > -->
        ...
        <!-- <span slot="footer" class="dialog-footer">
          ...
          <el-button type="primary" @click="addResource">通 过</el-button>
        </span>
      </el-dialog> -->
      ...
      <!-- 内容主体区 -->
        <el-form :model="editForm" :rules="modifyFormRules" ref="editForm" label-width="auto">
          ...
          <el-form-item label="流程创建时间">
            <el-input v-model="editForm.creatTime" disabled></el-input>
          </el-form-item>
          ...
          <el-form-item label="接报时间">
            <el-input v-model="editForm.alarmTime" disabled></el-input>
          </el-form-item>
          <el-form-item label="风险企业">
            <el-input v-model="editForm.enterprise" disabled></el-input>
          </el-form-item>
          <el-form-item label="流程最后修改时间">
            <el-input v-model="editForm.lastModifyTime" disabled></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    pass(){
      this.$data.tableDataBegin.state = "已通过"
    }
  },
};
</script>

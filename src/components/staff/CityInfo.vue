...
<template>
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-table ref="multipleTable" :data="tableDataEnd" tooltip-effect="dark" style="width: 100%"
        ...
        <el-table-column label="操作" min-width="120px">
          <template slot-scope="scope">
            <el-tooltip class="item" effect="dark" content="修改城市信息" placement="top" :enterable="false">
              <!-- 修改按钮 -->
            ...
            <!-- 删除按钮 -->
            <el-tooltip class="item" effect="dark" content="删除城市信息" placement="top" :enterable="false">
      ...
      <!-- 添加物资的对话框 -->
      <el-dialog title="添加城市信息" :visible.sync="addDialogVisible" width="50%" @close="resetForm">
        <!-- 内容主体区 -->
      ...
      <!-- 添加交通情况的对话框 -->
      <el-dialog title="添加交通情况" :visible.sync="addTrafficVisible" width="50%" @close="resetTrafficForm">
        <!-- 内容主体区 -->
        <el-form :model="addTrafficForm" ref="addTrafficForm" label-width="auto" :rules="addTrafficRules">
      ...
      <!-- 修改物资的对话框 -->
      <el-dialog title="修改物资记录" :visible.sync="editDialogVisible" width="50%" label-width="auto" size="mini"
